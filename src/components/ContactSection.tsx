      ...
      <div className="relative z-10 container mx-auto">
        ...
        <div ref={cards.ref} className={`max-w-2xl mx-auto grid gap-4 stagger-children ${cards.isVisible ? "visible" : ""}`}>
          <a
            ...
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-[hsl(142,70%,40%)] text-white group-hover:scale-110 transition-transform duration-300">
          ...
          <a
            ...
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md gradient-yellow group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="group flex items-center gap-4 rounded-lg border border-border bg-card/80 backdrop-blur-sm p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md gradient-yellow group-hover:scale-110 transition-transform duration-300">
          ...
          <a
            ...
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-gradient-to-br from-[hsl(280,70%,50%)] to-[hsl(340,80%,55%)] text-white group-hover:scale-110 transition-transform duration-300">
