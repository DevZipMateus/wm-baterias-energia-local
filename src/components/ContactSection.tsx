...
<section id="contato" className="relative section-padding overflow-hidden">
    ...
    <div className="relative z-10 container mx-auto">
      <div className="text-center mb-12">
        ...
        <h2 className="font-heading text-3xl md:text-4xl font-bold text-slate-50">
      ...
      <div className="max-w-2xl mx-auto grid gap-4">
        ...
        className="flex items-center gap-4 rounded-lg border border-border bg-card/80 backdrop-blur-sm p-5 hover:shadow-md transition-shadow">

          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-[hsl(142,70%,40%)] text-white">
        ...
        <div className="flex items-center gap-4 rounded-lg border border-border bg-card/80 backdrop-blur-sm p-5">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md gradient-yellow">
        ...
        className="flex items-center gap-4 rounded-lg border border-border bg-card/80 backdrop-blur-sm p-5 hover:shadow-md transition-shadow">
          ...
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-gradient-to-br from-[hsl(280,70%,50%)] to-[hsl(340,80%,55%)] text-white">
